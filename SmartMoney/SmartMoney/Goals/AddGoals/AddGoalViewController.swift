...
class AddGoalViewController: UIViewController, AddGoalViewProtocol {
    ...
    private func setupUI() {
        ...
        titleTextField.placeholder = "Goal Title"
        ...
        targetAmountTextField.placeholder = "Target Amount"
        ...
        initialAmountTextField.placeholder = "Initial Amount (Optional)"
    ...
    @objc private func saveButtonTapped() {
        guard let title = titleTextField.text, !title.isEmpty else {
            displayError(message: "Please enter a title")
            return
        }
        ...
        guard let targetAmountText = targetAmountTextField.text, !targetAmountText.isEmpty,
            ...
            displayError(message: "Please enter a valid target amount")
            return
        }
        ...
        if let initialAmountText = initialAmountTextField.text, !initialAmountText.isEmpty {
            guard let amount = Double(initialAmountText) else {
                displayError(message: "Please enter a valid initial amount")
                return
            }
        ...
        let request = AddGoal.CreateGoal.Request(
            title: title,
